...
// console.warn(`Afiseaza numele complet inversat al tuturor prietenilor, insa o data ce l-ai gasit pe steven, opreste
// bucla cu ajutorul keywordului break si afiseaza propozitia: “M-am oprit la Stevenson Steven.”.`);

// for (i = 0; i < friendsLength; i++) {}
// // de terminat

// console.warn(`Folosind keywordul continue, afiseaza numele complet inversat al prietenilor, doar daca numarul de caractere total al numelor lor este mai mare de 13 sub forma de propozitii “Prenume Nume are mai mult de 13 caractere.”.
// `);

// for (i = 0; i < friendsLength; i++) {
//   var friend = friends[i];
//   var fullNameLength = `${friends.name}${friend.surname}`.length;
